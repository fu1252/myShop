<template>
    <div class="addaddress">
      <div class="item">
        <input type="text" placeholder="姓名" v-model="userName" focus='true'>
      </div>
      <div class="item">
        <input type="text" placeholder="手机号码" v-model="telNumber"focus='true'>
      </div>
      <div class="item">
  ...
  export default {
    ...
    mounted() {
      ...
      if (this.$root.$mp.query.res) {
        this.res = JSON.parse(this.$root.$mp.query.res);
